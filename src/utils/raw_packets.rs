...
pub(crate) mod test_packets {
    ...
    #[rustfmt::skip]
    pub(crate) const ICMPV6_PACKET: [u8; 86] = [
        // ethernet header
        0x00, 0x00, 0x86, 0x05, 0x80, 0xda,
        0x00, 0x60, 0x97, 0x07, 0x69, 0xea,
        0x86, 0xdd, //ipv6
